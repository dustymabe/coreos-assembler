...
func kolaRunPatterns(patterns []string, rerun bool) error {
	...
	runErr := kola.RunTests(patterns, runMultiply, rerun, rerunSuccessTags, kolaPlatform, outputDir, !kola.Options.NoTestExitError, kola.Options.UseExitWarnCode77)
...
func runRunUpgrade(cmd *cobra.Command, args []string) error {
	...
	runErr := kola.RunUpgradeTests(patterns, runRerunFlag, kolaPlatform, outputDir, !kola.Options.NoTestExitError, kola.Options.UseExitWarnCode77)
